...
Scenario: Create a new user with only lastName field
  ...
  Scenario: Create a new user with only firstName field
     ...
     | mrs   | ciro      | alves    | https://randomuser.me/api/portraits/women/60.jpg | female | ciroalves@yahoo.com         | 1975-06-04T08:26:49.610Z  | +91091212292 | S. Roberts Road | Palos Hills | Illinois | United States of America | 4        |
      When I send a POST request to create a user
      Then The response code is 400
